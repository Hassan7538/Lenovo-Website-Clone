...
<body class="backImg">
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <div class=" mainclForm txtForm text-center ">
            <h2>Enter your email to view feedback</h2><br>
            <input type="email" style="font-weight: bold;" name="email" class="form-control  inpPropForm"
                placeholder="john@xyzmail.com" required>
            <br>
            <button type="submit" name="submit" value="submit" class="buttonForm btn btn-success float-end ">View
                Feedback</button><br>
        </div>
    </form>
    ...
    <div class="reg text-center">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $foundingEmail = $connect->query("SELECT id FROM feedback WHERE email = '$email' LIMIT 1");
            if ($foundingEmail->num_rows == 0) {
                echo "<script>
                    alert('No feedback against this email. Give feedback..');
            ...
            // Selecting values in table
                ...
                if ($result->num_rows > 0) {
                    ...
                    // while loop to select every feedback given
